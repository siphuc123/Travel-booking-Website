								...
								<div class="ms-auto text-end">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Lượt mua sản phẩm</li>
										</ol>
									</nav>
								</div>
							</div>
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card">
									<div class="card-body">
										<h5 class="card-title">Lượt mua sản phẩm</h5>
									</div>
									<table class="table container table-bordered table-dark" border="1" style="width: 100%">
										<thead class="fw-bold text-warning table-active">
											<tr>
												<th>ID</th>
												<th>Tên sản phẩm</th>
												<th>Tổng giá</th>
										...
										<tbody>
											<c:forEach var="item" items="${items}">
												<tr>
													...
													<td>
														<fmt:formatNumber value="${item.sum}" pattern="#,### VNĐ"></fmt:formatNumber>
													</td>
													<td>${item.count}</td>
												</tr>
											</c:forEach>
