					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
								data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline text-gray-600 small">${item.fullname}</span>
								<c:choose>
									<c:when test="${empty item.photo}">
										<img src="/assets/images/undraw_profile.svg" alt="user" class="rounded-circle" width="31">
									</c:when>
									<c:otherwise>
										<img class="img-profile rounded-circle" src="/photo/${item.photo}">
									</c:otherwise>
								</c:choose>
							</a>
								...
								<div class="ms-auto text-end">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Tài khoản của <b>${item.fullname}</b></li>
										</ol>
									</nav>
								</div>
							</div>
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="row">
									<div class="col-lg-4">
										<img src="/photo/${item.photo}" width="100%" height="70%" class="border border-dark rounded-4 rounded">
									</div>
									<div class="col-lg-8">
										<form:form action="/admin/account/index" modelAttribute="item" class="form-horizontal">
											<div class="card-body">
												<div class="form-group row">
													<label for="fname" class="col-sm-3 text-end control-label col-form-label">Tên
														đăng nhập</label>
													<div class="col-sm-9">
														<form:input path="username" type="text" class="form-control" id="fname"
															placeholder="Tên đầy đủ" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname" class="col-sm-3 text-end control-label col-form-label">Mật
														khẩu</label>
													<div class="col-sm-9">
														<form:input path="password" type="text" class="form-control" id="fname"
												...
												<div class="form-group row">
													<label for="fname" class="col-sm-3 text-end control-label col-form-label">Tên
														đầy đủ</label>
													<div class="col-sm-9">
														<form:input path="fullname" type="text" class="form-control" id="fname"
															placeholder="Tên đầy đủ" />
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input path="email" type="text" class="form-control" id="fname"
															placeholder="Email" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname" class="col-sm-3 text-end control-label col-form-label">Ảnh
														đại diện</label>
													<div class="col-sm-9">
														<form:input path="photo" type="text" class="form-control" id="fname"
															placeholder="Ảnh đại diện" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname" class="col-sm-3 text-end control-label col-form-label">Vai
														trò</label>
													<div class="col-sm-9">
														<form:input path="admin" type="text" class="form-control" id="fname"
															placeholder="Vai trò" />
													</div>
												</div>
												<div class="form-group row">
													<label for="fname" class="col-sm-3 text-end control-label col-form-label">Trạng
														thái</label>
													<div class="col-sm-9">
														<form:input path="activated" type="text" class="form-control" id="fname"
															placeholder="Trạng thái" style="color:green" />
													</div>
												</div>
											</div>
											<div class="border-top">
												<div class="card-body d-flex justify-content-end">
													<button class="btn btn-success text-white" formaction="/admin/myaccount/update">Cập
														nhật</button>
												</div>
											</div>
										</form:form>
