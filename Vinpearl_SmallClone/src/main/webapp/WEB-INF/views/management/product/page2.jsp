					...
					<div class="container-fluid">
						...
						<div class="row ">
							<div class="col-md-12 px-1 pt-2">
								<div class="d-flex px-4 pb-3" style="justify-content: space-between;">
									<h4 class="p-3 btn-dark fw-bold rounded-pill text-info">Quản lý sản phẩm</h4>
									<div class="fs-2 btn btn-info" style="display: flex; align-items: center;">📝</div>
								</div>
											...
											<div class="col-md-12">
												<nav>
													<ul class="nav nav-tabs nav-fill" id="nav-tab" role="tablist" id="myTab">
														<li class="tabs_product nav-item" id="nav-home-tab" role="tab"
															...
															<a href="#nav-edit" class="nav-link active" data-bs-toggle="tab"> Edit Product </a>
														</li>
														<li class="tabs_product nav-item" id="nav-profile-tab" role="tab"
															aria-controls="nav-profile" aria-selected="false">
															<a href="#nav-list" class="nav-link" data-bs-toggle="tab"> List Product </a>
														</li>
													</ul>
												</nav>
												<div class="tab-content" id="nav-tabContent">
													<div class="tab-pane fade show active" id="nav-edit" role="tabpanel"
														...
														<form:form action="/admin/product/page" modelAttribute="item">
															<div class="p-3 border border-4 border-info rounded">
																<div class="col-12">
																	<label for="ID" class="me-3 form-label">ID:</label>
																	<form:input id="ID" path="id" placeholder="Số thứ tự?" class="form-control"
																		disabled="true" />
																</div>
																<div class="col-12 mt-2">
																	<label for="NAME" class="me-3 form-label">Tên Tour du lịch:</label>
																	<form:input id="NAME" path="name" placeholder="Tên của sản phẩm?"
																		required="required" class="form-control" />
																</div>
																<div class="col-12 mt-2">
																	<label for="IMG" class="me-3 form-label">Ảnh minh họa:</label>
																	<form:input id="IMG" path="image" type="file" required="required"
																		class="form-control" />
																</div>
																<div class="col-12 mt-2">
																	<label for="PRICE" class="me-3 form-label">Giá Tour / người:</label>
																	<form:input id="PRICE" path="price" type="text" required="required"
																		class="form-control" />
																</div>
																<div class="col-12 my-2">
																	<label for="CATEGORY_ID" class="me-3 form-label">Thuộc thể loại:</label>
																	<form:select id="CATEGORY_ID" path="category.id" placeholder="Số thứ tự?"
															...
															<div class="d-flex bg-secondary p-3 rounded-3 mt-1"
																...
																<a class="btn btn-danger rounded-pill border border-3"
																	href="/admin/product/delete/${item.id}">Delete</a>
																<a class="btn btn-dark text-white rounded-pill border border-3"
																	href="/admin/product/page">Reset</a>
															</div>
														</form:form>
													</div>
													<div class="tab-pane fade p-3 border border-4 border-info" id="nav-list"
														...
														<div class="d-flex mb-3" style="justify-content: space-between;">
															...
															<form action="/admin/product/search" method="post"
																...
																<input name="keywords" value="${keywords}" placeholder="Nhập thứ muốn tìm..."
																	class="col-4">
																<div class="col-4 row" style="justify-content: center;">
																	<input name="min" value="${param.min}" placeholder="Min Price?" class="me-3 col-5">
																	<input name="max" value="${param.max}" placeholder="Max Price?" class="col-5">
																</div>
																<div>
																	<a class="btn btn-info text-decoration" href="/admin/product/search-and-page">
																		Search</a>
																	<button formaction="/admin/product/search" class="btn btn-success me-3">Sort
																		Price</button>
																</div>
															</form>
														</div>
														...
														<div class="row">
															...
															<div class="col-md-8">
																<table border="1" style="width: 100%; font-size: 15px"
																	class="table table-bordered table-info text-dark table-hover fw-bold">
																	<thead>
																		<tr>
																			<th class="text-center">
																				<a href="/admin/product/page/sort?field=id"
																					class="d-flex justify-content-center">ID</a>
																			</th>
																			<th class="text-center">
																				<a href="/admin/product/page/sort?field=name"
																					class="d-flex justify-content-center">Name</a>
																			</th>
																			<th class="text-center">
																				<a href="/admin/product/page/sort?field=price"
																					class="d-flex justify-content-center">Price</a>
																			</th>
																			<th class="text-center w-25">
																				<a href="/admin/product/sort?field=createDate"
																					class="d-flex justify-content-center">Date</a>
																			</th>
																			<th class="text-center">
																		...
																		<c:forEach var="item" items="${page.content}">
																			<tr>
																				...
																				<td class="text-center">
																					<span
																						class="badge bg-warning rounded-pill d-inline d-flex justify-content-center">
																						<fmt:formatNumber value="${item.price}" pattern="#,### VNĐ"></fmt:formatNumber>
																					</span>
																				</td>
																				<td class="text-center">${item.createDate}</td>
																				<td class="text-center">
																					<a href="/admin/product/edit/${item.id}" class="text-decoration-none">
																						<span
																							class="badge p-2 bg-info rounded-pill d-inline d-flex justify-content-center">
																							Edit </span>
																					</a>
																					<a href="/admin/product/delete/${item.id}" class="text-decoration-none">
																						<span
																							class="badge mt-2 p-1 bg-danger rounded-pill d-inline d-flex justify-content-center">
															...
															<div class="col-md-4">
																<ul
																	class="pt-3 border border-4 border-warning bg-gradient-white text-dark pb-3 w-100">
																	<li>
																		Số thực thể hiện tại:
																		<b>${page.numberOfElements}</b>
																	</li>
																	<li>
																		Trang số:
																		<b>${page.number}</b>
																		...
																		<ul class="pagination pagination-circle">
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/product/page?p=0">First</a>
																			</li>
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/product/page?p=${page.number-1}">Previous</a>
																			</li>
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/product/page?p=${page.number+1}">Next</a>
																			</li>
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/product/page?p=${page.totalPages-1}">Last</a>
																			</li>
																		</ul>
																	</nav>
																</div>
