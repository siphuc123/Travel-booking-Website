						...
						<div class="row ">
							<div class="col-md-12 px-3 pt-2">
								<div class="d-flex px-5 pb-2" style="justify-content: space-between;">
									<h4 class="p-3 btn-dark fw-bold rounded-pill text-warning">Quản lý danh mục</h4>
									<div class="fs-2 btn btn-warning shadow-3" style="display: flex; align-items: center;">🕶️</div>
								</div>
												...
												<nav>
													<ul class="nav nav-tabs nav-fill" id="nav-tab" role="tablist" id="myTab">
														<li class="tabs_product nav-item" id="nav-home-tab" role="tab"
															...
															<a href="#nav-edit" class="nav-link active" data-bs-toggle="tab"> Edit Category </a>
														</li>
														<li class="tabs_product nav-item" id="nav-profile-tab" role="tab"
															aria-controls="nav-profile" aria-selected="false">
															<a href="#nav-list" class="nav-link" data-bs-toggle="tab"> List Category </a>
														</li>
													</ul>
												</nav>
												<div class="tab-content" id="nav-tabContent">
													<div class="tab-pane fade show active" id="nav-edit" role="tabpanel"
														...
														<form:form action="/admin/category/index" modelAttribute="item">
															<div class="p-3 border border-4 border-warning rounded">
																<div class="col-12">
																...
																<div class="col-12 mt-2">
																	<label for="NAME" class="me-3 form-label">Tên danh mục:</label>
																	<form:input id="NAME" path="name" placeholder="Tên của loại sản phẩm?"
															...
															<div class="d-flex bg-secondary p-3 rounded-3 mt-1"
																...
																<a class="btn btn-dark text-white rounded-pill border border-3"
																	href="/admin/category/index">Reset</a>
															</div>
														</form:form>
													</div>
													<div class="tab-pane fade p-3 border border-4 border-info" id="nav-list"
														...
														<div class="d-flex mb-3" style="justify-content: space-between;">
															...
															<form action="/admin/category/search" method="post" class="p-2 d-flex">
																...
																<div>
																	...
																	<a class="btn btn-info text-decoration" href="/admin/category/Asearch">Advanced
																		Search</a>
																</div>
															</form>
														</div>
														...
														<div class="row">
															...
															<div class="col-md-8">
																<table border="1" style="width: 100%; font-size: 15px"
																	class="table table-bordered table-warning text-dark table-hover fw-bold">
																	<thead>
																		<tr>
																			<th class="text-center">
																				<a href="/admin/category/page/sort?field=id"
																					class="d-flex justify-content-center">ID</a>
																			</th>
																			<th class="text-center">
																				<a href="/admin/category/page/sort?field=name"
																		...
																		<c:forEach var="item" items="${page.content}">
																			<tr>
																				...
																				<td class="text-center">
																					<a href="/admin/category/edit/${item.id}" class="text-decoration-none">
																						<span
																							class="badge bg-info p-2 rounded-pill d-inline d-flex justify-content-center">
																							Edit </span>
																					</a>
																					<a href="/admin/category/delete/${item.id}" class="text-decoration-none">
																						<span
																		...
																		<ul class="pagination pagination-circle">
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/category/index?p=0">First</a>
																			</li>
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/category/index?p=${page.number-1}">Previous</a>
																			</li>
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/category/index?p=${page.number+1}">Next</a>
																			</li>
																			<li class="page-item mx-2">
																				<a class="page-link btn btn-warning border border-2 rounded-3 border-dark"
																					href="/admin/category/index?p=${page.totalPages-1}">Last</a>
																			</li>
																		</ul>
																	</nav>
																</div>
